...
export class AnswerService {
  ...
  store(answer: Answer): Observable<Answer> {
    return this.http.post<Answer>(AppConfig.API_ENDPOINT + 'answers', answer, this.httpOptions)
      .pipe(
        tap(_ => this.messageService.showMessage('Question updated successfully.')),
        catchError(this.handleError<Answer>('store Chapter}'))
      )
  }
  ...
  delete(answer: Answer | number): Observable<Answer> {
    ...
    return this.http.delete<Answer>(AppConfig.API_ENDPOINT + 'answers/' + id, this.httpOptions)
    .pipe(
